...
cross_radius = float(0.0002) # radius of cross-immunity (the distance of half-of-value in the Monod equation)
...
inRateG_OAS_boost = 0/hour # boosting in-rate of antibody-IgG from memory B-cell for origin-virus
